                    ...
                    <div className='bg-blue-50 '>
                        <div className=' '>
                            <div className=" border shadow-md shadow-blue-300 px-2 py-6 md:p-8 text-center rounded-md">
                                <h2 className='text-2xl font-bold text-blue-700'>Update Products</h2>
                            </div>
                            <div className=' mt-4 '>

                                <form className=" border shadow-xl shadow-blue-300 px-2 py-6 md:p-8 rounded-md" onSubmit={handleSubmit}>
                                    <div className='flex flex-col w-full'>
                                        <label className=' text-gray-600 font-semibold block ' htmlFor='productName'>
                                            Name
                                        </label>
                                        <input
                                    ...
                                    <div className='flex space-x-4 justify-between mt-2'>
                                        ...
                                        <div className='w-1/2'>
                                            ...
                                            >
                                                ...
                                                {
                                                    brands.map(brand => <option value={brand?.brandName}>{brand?.brandName} </option>)
                                                }
                                        ...
                                        <div className='w-1/2'>
                                            <label className=' text-gray-600 font-semibold block ' htmlFor='type'>
                                                Type
                                            </label>
