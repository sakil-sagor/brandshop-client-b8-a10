        ...
        <div className={`flex  flex-col h-full  shadow-xl hover:shadow-2xl duration-200   rounded-md relative ${darkMode ? "bg-gray-400" : "bg-pink-50"}`}>
            ...
            <div className='p-2'>
                ...
                <div className='my-4 grid grid-cols-2 gap-x-6'>
                    <Link to={`/product/${_id}`} >  <button className='  border border-blue-700 text-blue-700 hover:bg-blue-700 hover:text-white duration-200  py-1 w-full rounded'>Details</button></Link>
